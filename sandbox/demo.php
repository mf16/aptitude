...
<div id="allButSideBar">
	<div class="pageWrap">
		...
		<section id="contentWrapper">
			...
			<section id="rightInfoBar" class="col-md-3 col-md-12">
				<article class="text-center">
					...
					<section class="sidebarRow" id="state_1_1">
						<article class="col-md-12 desktopContent">
					...
					<section class="sidebarRow" id="state_1_3">
						<article class="col-md-2 desktopContent">
					...
					<section class="sidebarRow" id="state_1_4">
						<article class="col-md-2 desktopContent">
