				...
				<section class="row-fluid">
					<section class="col-lg-9 col-xs-12 text-body">
						...
						<section class="col-md-10 material-body">
							...
							<p class="vote-text">ongratulations! Looks like you already know <b>Composition of Functions</b> somewhat well, but let's go over a few things just to make sure you have a solid understanding.</p>
							<br/>
						...
						<section class="col-md-10 text-body">
							...
							<article class="margin-top  postDefinition">
