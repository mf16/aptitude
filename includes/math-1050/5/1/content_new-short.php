				...
				<section class="row-fluid">
					<section class="col-lg-9 col-xs-12 text-body">
						...
						<section class="col-md-10 material-body">
							...
							<p>ongratulations! You got enough questions correct to skip most the reading for this section. Please look over the following summary points and take the post-reading test.</p>
